...
import { initialStateValue, scrambleWordReducer } from './reducer/scrambleWordReducer';

export const ScrambleWords = () => {

  const [state, dispatch] = useReducer(scrambleWordReducer, initialStateValue());
  ...
  const handlePlayAgain = () => {
    dispatch({
      type: 'START_GAME_AGAIN',
      payload: initialStateValue(),
    })
  };
